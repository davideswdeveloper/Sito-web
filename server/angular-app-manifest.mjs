...
export default {
  ...
  assets: {
    ...
    'db/index.html': {size: 14880, hash: 'a38f4b37d6aee063b21aeaf59fa01bbf986ef92c659d5511c9b0feb1acba97de', text: () => import('./assets-chunks/db_index_html.mjs').then(m => m.default)},
